                            ...
                            <table id="example1" class="table table-bordered table-striped table-sm">
                                ...
                                foreach ($proveedores_datos as $proveedores_dato){
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $proveedores_dato['ciudad'];?></td>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <select name="ciudad" id="ciudad" class="form-control">
                                ...
                                <option value="Ciudad 4">Cuenca</option>
...
<script>
    $('#btn_create').click(function () {
        ...
        if(nombre_proveedor == ""){
            ...
            $.get(url,{nombre_proveedor:nombre_proveedor,celular:celular,telefono:telefono,empresa:empresa,email:email,ciudad:ciudad,direccion:direccion},function (datos) {
                $('#respuesta').html(datos);
            });
        }
