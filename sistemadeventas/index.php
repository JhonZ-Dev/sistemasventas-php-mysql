...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-12">
                    <h1 class="m-0"><span style="font-size: 60px;" id="w">W</span ><span style="font-size: 60px;" id="e">e</span> <span style="font-size: 60px;" id="m">M</span ><span id="a" style="font-size: 60px;">a</span><span id="k" style="font-size: 60px;">k</span><span id="e1" style="font-size: 60px;">e</span><span id="r" style="font-size: 60px;">r</span><span id="s" style="font-size: 60px;">s</span></h1>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    </div>
